...
export interface Event {
  id: string;
  actor: { id: string; name: string | null; type: string | null };
  action: string;
  ...
  version: number | null;
  integrity: { event_hash: string | null; previous_event_hash: string | null };
...
export interface AlertItem {
  ...
  reason: string;
  event: { id: string; action: string; actor_id: string } | null;
